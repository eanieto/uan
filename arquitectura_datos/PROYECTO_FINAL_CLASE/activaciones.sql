...
SELECT
       COUNT(1) ACTIVACIONES,
       DP.NOMBRE_PLAN
FROM FACT_ACTIVACIONES_PREPAGO FACT
INNER JOIN DIM_AGENTE DA on FACT.SK_AGENTE = DA.SK_AGENTE
INNER JOIN DIM_CLIENTES DC on FACT.SK_CLIENTE =  DC.SK_CLIENTE
INNER JOIN DIM_PLANES_PREPAGO DP ON FACT.SK_PLAN = DP.SK_PLAN_PREPAGO
